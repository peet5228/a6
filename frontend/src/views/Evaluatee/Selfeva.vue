                        ...
                        <v-col cols="12">
                            ...
                            <v-card class="pa-2">
                                <v-row v-for="(indicate,index2) in topic.indicates" :key="indicate.id_indicate">
                                    <v-col cols="12">
                                        <p>
                                            {{ index1+1 }}.{{ index2+1 }} {{ indicate.name_indicate }} น้ำหนักคะแนน {{ indicate.point_indicate }} คะแนนเต็ม {{ indicate.point_indicate }} รายละเอียดตัวชี้วัด {{ indicate.detail_indicate }}
                                        </p>
                                        ...
                                        <v-select v-if="indicate.check_indicate === 'y'" label="ใส่คะแนนประเมิน" :items="[1,2,3,4]" v-model="indicate.score"></v-select>
                                        <v-text-field v-else type="number" v-model="indicate.score" label="ใส่คะแนนประเมิน"></v-text-field>
                                    </v-col>
                                </v-row>
                            </v-card>
                        </v-col>
